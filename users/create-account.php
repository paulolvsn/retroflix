    ...
    <body class="bg-dark text-white">
        ...
        <main class="container">
            ...
            <div class="row mt-5">
                ...
                <div class="col border border-white border-2 rounded shadow p-3 mb-5 mt-5">
                    <form action="create-account-check.php" method="post" enctype='multipart/form-data'>

                        <h2 class="text-center">S'inscrire</h2>
                            
                        <div class="card form-control" >
                            <img class="figure-img img-fluid mx-3" id="avatarDisplay" width="460px" height="auto" src="avatar/avataroffert.png"  alt="avatar"><br>
                        ...
                        <div class="dropdown">
                            <button class="btn btn-secondary dropdown-toggle" type="button" id="avatardd" data-bs-toggle="dropdown" aria-expanded="false" data-bs-offset="200,-160">
                                Images disponibles
                            </button>
