    ...
    <body> 
        <div style="width: 50%;margin: auto; background-color: rgba(40, 40, 40, 1);"> 
            <div class="row mt-3"> 
                ...
                <h2 style="text-align: center; color:#fcba03">Bonjour</h2> 
                </div> 
            </div> 
            <div class="row"> 
                <div class="col-md-offset-3 mt-4 mb-3 text-center"> 
                <h4 style="text-align: center;color:#fcba03">Pour enregistrer un nouveau mot de pas veuillez cliquer sur le lien suivant:</h4> 
                </div> 
            </div> 
            <div class="row"> 
